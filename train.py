...
from src.pretrained_model import CustomShuffleNet, CustomSqueezeNet
...
def train(
    ...
    model_instance = CustomSqueezeNet()
    model_path = os.path.join(log_dir, "best.pt")
    model_instance.model = torch.hub.load(
        "pytorch/vision:v0.8.0", "squeezenet1_1", pretrained=True
    )
    ...
    optimizer = torch.optim.Adam(model_instance.parameters(), lr=0.0001)
